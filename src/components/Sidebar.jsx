  ...
  return (
    <div className='w-[20%] bg-gray-100 shadow-md h-[87vh] py-4 px-2'>
        <ul className='flex flex-col gap-6'>
            <Link className='text-xl border-b-1 p-2 border-gray-300 hover:bg-emerald-300'>Home</Link>
            <Link className='text-xl border-b-1 p-2 border-gray-300 hover:bg-emerald-300'>Pinned Notes</Link>
